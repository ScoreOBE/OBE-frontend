...
export default function Sidebar() {
  ...
  return (
    <div className="w-64 - h-screen flex justify-center font-sf-pro ">
      <div className="absolute top-5 flex flex-col gap-11 text-white ">
        ...
        <div className="flex flex-col gap-11">
          <div className="text-sm flex flex-col gap-1">
            ...
            <div className="font-light flex flex-col gap-[2px]">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Button
              className="bg-transparent w-full h-[50px]  flex justify-start items-center px-3 py-1 border-none rounded-lg text-white transition-colors duration-300 hover:[#F0F0F0] hover:text-black  focus:border-none "
              leftSection={
                <svg
                  className="flex flex-col justify-start h-full -mt-4 mr-2"
            ...
            >
              <div className="flex flex-col justify-start items-start gap-2 ">
                ...
                <p className="font-light text-[13px]">Course (1/67)</p>
              </div>
            </Button>
          </div>
        </div>
