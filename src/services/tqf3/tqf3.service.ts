...
export const getCourseReuseTQF3 = async (params: any) => {
  const tqf3Service = tqf3Controller();
  const res = await tqf3Service.getCourseReuseTQF3(params);
  return isValidResponse(res);
};

export const reuseTQF3 = async (params: any) => {
  const tqf3Service = tqf3Controller();
  const res = await tqf3Service.reuseTQF3(params);
  return isValidResponse(res);
};
