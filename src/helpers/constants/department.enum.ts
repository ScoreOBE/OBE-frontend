...
export enum DEPARTMENT_TH {
  ...
  MN = "วิศวกรรมเหมืองแร่",
  CPE = "วิศวกรรมคอมพิวเตอร์",
  ISNE = "วิศวกรรมระบบสารสนเทศและเครื่อข่าย",
  ME_INTER = "วิศวกรรมเครื่องกลและการบริหารโครงการวิศวกรรม",
  REAI = "วิศวกรรมหุ่นยนต์และปัญญาประดิษฐ์",
  INTEGRATION = "วิศวกรรมบูรณาการ",
